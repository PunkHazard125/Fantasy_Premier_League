...
#define exit_msg cout << "Exited!" << endl
#define invalid_msg cout << "Invalid Choice!\n" << endl
#define ln "\n"
#define println cout << "\n"
...
namespace League {
    ...
    inline void display_standings() {
        ...
        cout << "======================================================\n";
        cout << "        Premier League Standings | Matchday " << matchday_count << "         \n";
        cout << "======================================================\n";
    ...
    inline void display_team_info(int id) {
        ...
        cout << left << setw(17) << "Team Name:" << team.get_name() << ln << ln;
        ...
        cout << left << setw(17) << "Wins:" << team.get_wins() << ln;
        cout << left << setw(17) << "Draws:" << team.get_draws() << ln;
        cout << left << setw(17) << "Losses:" << team.get_losses() << ln << ln;
    ...
    inline void display_history() {
        ...
        cout << "======================================================\n";
        cout << "      Premier League Standings | Previous Season      \n";
        cout << "======================================================\n";
        cout << left << setw(5) << "Rank"
            << setw(25) << "Team"
            << setw(8) << "Points"
